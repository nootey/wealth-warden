            ...
            <div class="flex flex-column gap-3">
                ...
                <div class="flex flex-row w-full">
                    <div class="flex flex-column gap-1 w-full">
                        <label>Email</label>
                        <InputText id="email" v-model="emailInput" type="email"
                                   :disabled="loading"
                                   class="w-full border-round-xl"/>
                    </div>
                </div>

                <Button label="Request password reset" class="w-full auth-accent-button"
                        :disabled="loading"  @click="requestPasswordReset"></Button>
