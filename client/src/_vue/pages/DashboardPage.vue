...
<template>
    <main class="flex flex-column w-full p-2 align-items-center">
        ...
        <div id="page-container" class="flex flex-column justify-content-center p-3 w-full gap-2 border-round-md"
            ...
            <SlotSkeleton bg="transparent">
                <div class="w-full flex flex-row justify-content-between p-2 gap-2 align-items-center">
                    ...
                    <Button label="Refresh" icon="pi pi-refresh" style="height:42px;"
                            class="main-button" @click="backfillBalances"></Button>
                </div>
            </SlotSkeleton>
