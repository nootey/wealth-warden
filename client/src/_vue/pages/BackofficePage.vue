      ...
      <div class="flex flex-column gap-3">
        ...
        >
          ...
          <div class="text-sm text-color-secondary">
            ...
            cash outflows in the balance ledger, then rebuilds all account
            snapshots. Run this once after the investment cash flow refactor to
            fix historical net worth charts. <strong>Do not run again</strong> —
            it will double-count existing cash outflows.
          </div>
          <div class="mt-2">
            <Button
              label="Run backfill"
