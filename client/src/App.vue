...
<template>
  ...
  <div id="app">
    ...
    <div
      ...
      :style="{ 'margin-left': (isAuthenticated && isInitialized && !hideNavigation) ? '80px' : '0px' }"
    >
      <div
      ...
      <div v-else>
        <div
          v-if="!isSettingsView && isAuthenticated && isInitialized && !hideNavigation"
          id="breadcrumb"
