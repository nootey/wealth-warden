...
type backfillRunner struct {
	worker *queue_jobs.BackfillAssetCashFlowsWorker
}

func (r backfillRunner) Run(ctx context.Context) error {
	return r.worker.Work(ctx, &river.Job[queue_jobs.BackfillAssetCashFlowsArgs]{JobRow: &rivertype.JobRow{}})
}

func (s *BackfillCashFlowsIntegrationSuite) newBackfillJob() backfillRunner {
	return backfillRunner{worker: queue_jobs.NewBackfillAssetCashFlowsWorker(
