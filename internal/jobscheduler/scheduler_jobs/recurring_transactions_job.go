...
type RecurringTransactionsWorker struct {
	river.WorkerDefaults[RecurringTransactionsArgs]
	logger    *zap.Logger
...
func (w *RecurringTransactionsWorker) Timeout(*river.Job[RecurringTransactionsArgs]) time.Duration {
...
func (w *RecurringTransactionsWorker) Work(ctx context.Context, _ *river.Job[RecurringTransactionsArgs]) error {
