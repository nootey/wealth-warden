...
func (r *RouteInitializerHTTP) initV1Routes(_v1 *gin.RouterGroup, wm *middleware.WebClientMiddleware) {
	...
	rulesHandler := httpHandlers.NewRulesHandler(r.Container.RulesService, validator)
	...
	jobHandler.Routes(protected.Group("/jobs"))
	...
	rulesHandler.Routes(protected.Group("/rules"))
