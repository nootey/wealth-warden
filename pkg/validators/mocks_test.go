...
func (_mock *MockValidator) ValidateStruct(data interface{}) error {
...
func (_c *MockValidator_ValidateStruct_Call) RunAndReturn(run func(data interface{}) error) *MockValidator_ValidateStruct_Call {
	_c.Call.Return(run)
	return _c
}
